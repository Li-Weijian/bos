...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#grid').datagrid( {
			...
			pagination : true,
			toolbar : toolbar,
			url : "decidedzoneAction_quaryPage.action",
			idField : 'id',
			columns : columns,
			...
			<form id="addDecidedzoneForm" method="post" action="decidedzoneAction_save.action">
				<table class="table-edit" width="80%" align="center">
					...
					<tr height="300">
						...
						<td>
							<table id="subareaGrid"  class="easyui-datagrid" border="false" style="width:300px;height:300px" data-options="url:'subareaAction_quaryPage.action',fitColumns:true,singleSelect:false">
								<thead>  
							        <tr>  
